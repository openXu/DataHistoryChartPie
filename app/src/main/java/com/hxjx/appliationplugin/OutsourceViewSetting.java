    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_5:
                ...
                pieDatas.add(new PieDataEntity("张飞", 45, Constant.CHARTCOLOR[8]));
                pieDatas.add(new PieDataEntity("赵云", 25, Constant.CHARTCOLOR[9]));
                pieDatas.add(new PieDataEntity("刘备", 65, Constant.CHARTCOLOR[10]));
                pieDatas.add(new PieDataEntity("王朝", 58, Constant.CHARTCOLOR[11]));
                pieDatas.add(new PieDataEntity("马汉", 94, Constant.CHARTCOLOR[12]));
                pieDatas.add(new PieDataEntity("周杰伦", 79, Constant.CHARTCOLOR[13]));
                pieDatas.add(new PieDataEntity("陈奕迅", 26, Constant.CHARTCOLOR[14]));
                pieDatas.add(new PieDataEntity("张建立", 19, Constant.CHARTCOLOR[15]));
                pieDatas.add(new PieDataEntity("郝建", 34, Constant.CHARTCOLOR[16]));
                pieDatas.add(new PieDataEntity("黄宏", 42, Constant.CHARTCOLOR[17]));
                pieDatas.add(new PieDataEntity("周华健", 62, Constant.CHARTCOLOR[18]));
                pieDatas.add(new PieDataEntity("刘德华", 39, Constant.CHARTCOLOR[19]));
                pieDatas.add(new PieDataEntity("马德华", 59, Constant.CHARTCOLOR[20]));
                pieDatas.add(new PieDataEntity("六小龄童", 46, Constant.CHARTCOLOR[21]));
                pieDatas.add(new PieDataEntity("成龙", 39, Constant.CHARTCOLOR[22]));
                pieDatas.add(new PieDataEntity("吴京", 49, Constant.CHARTCOLOR[23]));
                pieDatas.add(new PieDataEntity("吴越", 79, Constant.CHARTCOLOR[24]));
                pieDatas.add(new PieDataEntity("李连杰", 66, Constant.CHARTCOLOR[25]));
                pieDatas.add(new PieDataEntity("李世明", 48, Constant.CHARTCOLOR[26]));
                pieDatas.add(new PieDataEntity("王二小", 65, Constant.CHARTCOLOR[27]));
                pieDatas.add(new PieDataEntity("邓超", 49, Constant.CHARTCOLOR[28]));
                pieDatas.add(new PieDataEntity("李小龙", 34, Constant.CHARTCOLOR[29]));
                break;
        }
